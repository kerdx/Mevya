...
- DMS verifica lo stato reale del servizio prima di avviare clipboard e fallback;
  se il servizio principale fallisce, viene fermato e viene attivato il fallback;
